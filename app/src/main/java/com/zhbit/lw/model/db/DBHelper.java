...
public class DBHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        // 插入聊天的测试数据
        String chatSql = "insert into chat_msg(user_id, friend_id, chat_msg_content, chat_msg_time, chat_msg_type)" +
                " values(1, 2, '您好，好久不见，近来可好。', '2017-2-18 12:30', 'receive')";
        String secondChatSql = "insert into chat_msg(user_id, friend_id, chat_msg_content, chat_msg_time, chat_msg_type)" +
                " values(1, 2, '还不错啦。', '2017-2-18 12:35', 'send')";
        String thirdChatSql = "insert into chat_msg(user_id, friend_id, chat_msg_content, chat_msg_time, chat_msg_type)" +
                " values(1, 3, '在吗？。', '2017-2-18 11:30', 'send')";
        db.execSQL(chatSql);
